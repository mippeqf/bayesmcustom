...
List rhierMnlDP_rcpp_loop(int R, int keep, int nprint,
                          ...
                          double bayesmcustomConstantA, int bayesmcustomConstantnuInc, double bayesmcustomConstantDPalpha){
...
// Wayne Taylor 2/21/2015
  ...
  double alpha = bayesmcustomConstantDPalpha;
 ...
 //initialize lambda
  lambda lambda_struct;
    ...
    lambda_struct.Amu = bayesmcustomConstantA;
    lambda_struct.nu = nvar+bayesmcustomConstantnuInc;

...
attributes(betadraw)$class=c("bayesmcustom.hcoef")
attributes(Deltadraw)$class=c("bayesmcustom.mat","mcmc")
attributes(Deltadraw)$mcpar=c(1,R,keep)
attributes(Vbetadraw)$class=c("bayesmcustom.var","bayesmcustom.mat","mcmc")

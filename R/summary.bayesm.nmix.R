summary.bayesmcustom.nmix=function(object,names,burnin=trunc(.1*nrow(probdraw)),...){
  nmixlist=object
...
attributes(mumat)$class="bayesmcustom.mat"
attributes(sigmat)$class="bayesmcustom.var"

...
if(is.null(Prior$nu.e)) {nu.e=bayesmcustomConstant.nu.e} 
...
if(is.null(Prior$Amu)) {Amu=matrix(bayesmcustomConstant.A,ncol=1)} else {Amu=matrix(Prior$Amu,ncol=1)}
...
attributes(draws$taudraw)$class=c("bayesmcustom.mat","mcmc")
